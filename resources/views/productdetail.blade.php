...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="{{url('collections')}}" class="stext-109 cl8 hov-cl1 trans-04">
				Collections
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
                                ...
                                @foreach ($productImages as $productImage)                                    
                                    ...
                                    <div class="item-slick3" data-thumb="{{asset('photos/'.$productImage->image_path)}}">
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <img src="{{asset('photos/'.$productImage->image_path)}}" alt="IMG-PRODUCT">

                                            {{-- <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/product-detail-01.jpg"> --}}
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{asset('photos/'.$productImage->image_path)}}">
